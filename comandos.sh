...
# A primeira linha do log mostra "Container rodando como usuario: vetflow" (nunca root)
# — impresso pelo proprio Dockerfile na inicializacao, evita depender do
# "az container exec" (trava sem erro no cmd.exe classico do Windows)

# (Sem Azure File Share nesta versao - ver comentario no criacao.sh sobre
# a incompatibilidade de permissoes entre Postgres e Azure Files/SMB.
# "Volume nomeado" nao e exigencia da Sprint 3.)
