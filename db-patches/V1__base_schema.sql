-- PATCH DE DEVOPS (não é o arquivo original do vetflow-java): só troca
-- AUTO_INCREMENT -> GENERATED BY DEFAULT AS IDENTITY e DOUBLE -> DOUBLE
-- PRECISION, p/ rodar em Postgres além de H2. Nenhuma tabela/coluna/dado
-- muda. Injetado no .jar pelo Dockerfile.
